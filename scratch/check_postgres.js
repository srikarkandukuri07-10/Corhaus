...
async function checkPostgres() {
  ...
  // Let's test inserting a fake user into auth.users directly via SQL or checking if any RPC is available
  const { data: rpcList, error: rpcErr } = await supabase.rpc('get_service_status');
  console.log('rpc test:', rpcErr?.message);
}
