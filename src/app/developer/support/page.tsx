                  ...
                  {selectedTicket.status !== "Closed" && (
                    <>
                      <button
                        ...
                        className="px-3.5 py-2 bg-emerald-600 text-white font-extrabold text-xs rounded-xl hover:bg-emerald-700 transition-all shadow-xs flex items-center gap-1.5"
                      >
                      ...
                      <button
                        ...
                        className="px-3.5 py-2 bg-gray-700 text-white font-extrabold text-xs rounded-xl hover:bg-gray-800 transition-all shadow-xs flex items-center gap-1.5"
                      >
                        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
