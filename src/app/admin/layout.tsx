          ...
          <div>
            ...
            <div className="space-y-1">
              <Link
                ...
                className={`flex items-center justify-between px-4 py-2.5 rounded-2xl text-[15px] font-semibold transition-all ${navLinkClass(pathname.startsWith("/admin/settings/roles"))}`}
              >
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
