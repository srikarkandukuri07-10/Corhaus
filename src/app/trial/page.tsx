        ...
        <div className="max-w-2xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-6 sm:p-8 space-y-5 shadow-2xl">
            ...
            <div>
              ...
              <select required value={interest} onChange={(e) => setInterest(e.target.value)} className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 bg-white focus:border-black focus:outline-none text-sm !text-gray-900 placeholder:text-gray-400">
            ...
            <div>
              ...
              <input type="text" value={preferredTime} onChange={(e) => setPreferredTime(e.target.value)} placeholder="e.g. Weekday mornings, 7-9 AM" className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 bg-white focus:border-black focus:outline-none text-sm !text-gray-900 placeholder:text-gray-400" />
            </div>
            ...
            <div>
              ...
              <textarea rows={3} value={message} onChange={(e) => setMessage(e.target.value)} placeholder="Tell us about your fitness goals..." className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-black bg-white focus:outline-none text-sm !text-gray-900 placeholder:text-gray-400 resize-none" />
            </div>
