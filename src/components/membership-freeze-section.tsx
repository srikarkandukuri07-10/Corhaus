    ...
    <div className="bg-surface rounded-2xl border border-line p-6 shadow-xs space-y-5">
      ...
      {!isPending && !isFrozen && data.latest_rejected && (
        <div className="p-3 bg-red-50 border border-red-200 rounded-xl text-xs text-red-800 flex items-center gap-2">
          ...
          <span>Your previous freeze request was not approved.</span>
        </div>
      )}
      ...
      {showRequestModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-xs p-4">
          <div className="bg-surface rounded-2xl border border-line shadow-xl max-w-md w-[95vw] p-6 space-y-5 max-h-[90vh] overflow-y-auto">
